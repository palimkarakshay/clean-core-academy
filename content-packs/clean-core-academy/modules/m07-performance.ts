...
export const m07Performance: Section = {
  ...
  blurb:
    "The five rules that fix 80% of slow SQL, the diagnostics toolkit, the declarative-projected-joined pattern that wins, hints and buffering, and the performance pitfalls rarely written down. How to make ABAP fast on a columnar, set-oriented database.",
  concepts: [
    {
      id: "m07-c1",
      code: "7.1",
