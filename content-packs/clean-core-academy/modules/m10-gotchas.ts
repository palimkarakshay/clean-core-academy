...
export const m10Gotchas: Section = {
  ...
  blurb:
    "The silent defects — code that compiles cleanly, passes a casual review, and then fails at runtime or after the next FPS. The Open SQL, internal-table, RAP, CDS, AMDP / ABAP Cloud, and transport-topology pitfalls every team should recognise, each with the mechanism behind it.",
  concepts: [
    {
      id: "m10-c1",
      code: "10.1",
