...
export const m02HanaReadiness: Section = {
  ...
  blurb:
    "What actually changes underneath your code when you move to HANA, the common and less-obvious pitfalls that silently return incorrect results, and the SCMON to ATC to baseline loop that scopes and manages the migration.",
  concepts: [
    {
      id: "m02-c1",
      code: "2.1",
